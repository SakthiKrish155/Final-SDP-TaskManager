...
const ManagerSettings = () => {
  ...
  const handleSave = async () => {
    try {
      const updatedData = { name, email, contact, password };
  ...
  return (
    <div className='m-10 flex justify-center items-center'>
      <div className="p-6 h-80% w-5/6 bg-background text-foreground rounded-lg shadow-lg">
...
// $2a$10$EqvUzW1p52QvfYEtxqjXp.L/aVZ3FkrMWcZgn7/tJ1bVAVZgr4alO